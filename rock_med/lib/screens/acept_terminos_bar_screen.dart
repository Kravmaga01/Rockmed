...
class AceptTerminosCreatebar extends StatelessWidget {
  const AceptTerminosCreatebar({Key? key}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  // caja de texto
                  'Te contamos que sólo podras registrar un perfil por Bar',
